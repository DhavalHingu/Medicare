...
<center>
	<form action="stock_register.php" method="POST">
		<!-- ============================== Fieldset 1 ============================== -->
		<fieldset>
			<legend>Stock Register</legend><br>
			<p><label>Date:</label> <input type="date" name="date" id="d" required></p><br>
		   <p><label>Name:</label> <input type="text" name="name" required></p><br>
		   <p><label>Type:</label> <input type="text" name="type" required></p><br>
           <p><label>Batch No:</label> <input type="text" name="batch" required></p><br>
		   <p><label>Quantity:</label> <input type="text" name="qun" required></p><br>
			<p><label>Exp Date:</label> <input type="date" name="exp" required></p><br>
