...
include("connect.php");
 ...
 $result=mysql_query("select * from `centers`");
 ?>
 <html>
<head>
	<title>Invoice</title>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
	...
	<table class="data-table">
		<caption class="title"><div class="no"><a href="#" onclick="window.print();"><font color="red">(print)</font></a></div>   List Of Centers</caption>
		<thead>
			<tr>
				<th>ID</th>
				<th>CODE</th>
...
echo "<td>".$row['id']."</a>
<div class='no'><a href='delete_cen.php?id1=" .$row['id'] ."'>Delete</a></div></td>";
			echo "<td>".$row['code']."</td>";
