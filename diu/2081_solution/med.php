...
<center>
	<form action="medicine_reg.php" method="post">
        ...
        <?php
               include('connect.php');
             $sel=mysql_query("SELECT `name` FROM `stock`  WHERE MONTH(date) = MONTH(CURRENT_DATE)") or die(mysql_error());
        ...
        <p><label>Batch No:</label>
        <input type="text" name="cost" id="cost"></p><br>  
<p><label>Select Type:</label>
        ...
        <?php
               include('connect.php');
             $sel=mysql_query("SELECT `type` FROM `stock`  WHERE MONTH(date) = MONTH(CURRENT_DATE)") or die(mysql_error());
        ...
        <?php } ?>
		    ...
		    <p><label>Recorder Level:</label> <input type="text" name="level"></p><br>
		...
		<!-- ============================== Fieldset 2 ============================== -->
		<form action="dignoses_reg.php" method="post">
		<fieldset>
			<legend>Diagnoses</legend>
				<p><label>Code:</label> <input type="text" name="code"></p><br>
				<p><label>Diagnosis:</label> <input type="text" name="diagno"></p><br>
				<p><input class="submit-button" type="submit" alt="SUBMIT" name="submit" value="SUBMIT" /></p>
