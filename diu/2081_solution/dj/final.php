	...
	<form id="form">
		...
		<fieldset>
			...
			<p><label>Case_No:</label>
               ...
               <input type="text" id="contact1"/></p><br/>
...
<p><label>Religion:</label>
 ...
 <p><label>Diagnosis:</label>
				...
				<select name=dig id="diagnosis">
					<option>--select--</option>
				<?php
               include('connect.php');
             $sel=mysql_query("SELECT `diagno` FROM `diagnosis`") or die(mysql_error());
                        
            while($row=mysql_fetch_array($sel)){?>
            <option value="<?php echo $row['diagno'];?>"><?php echo $row['diagno'];?></option>
