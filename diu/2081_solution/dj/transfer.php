...
document.getElementById('dk').value = today;
}
</script>
...
<center>
	<form id="form">
		...
		<fieldset>
			...
			<p><label>center:</label>  <select id="c_name"  onchange="dhaval(this.value);"><option>---select---</option>
		   	<?php
                include 'connect.php';
			...
			<p><label>Code:</label> <input type="text" id="co"></p><br>
					    <p><label>Date:</label> <input type="date" id="dk"></p><br>
		   <p><label>Select Medicines:</label> <select id="drug_name"  onchange="feestype(this.value);"><option>---select---</option>
		   	<?php
                include 'connect.php';
                      $driver = mysql_query("SELECT * FROM stock WHERE MONTH(date) = MONTH(CURRENT_DATE)");
                      while($row = mysql_fetch_array($driver))
                      {
			...
			<p><label>Batch No:</label> <input type="text" id="cost"></p><br>
