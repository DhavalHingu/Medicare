...
include("connect.php");
 ...
 $result=mysql_query("select * from `medicines`");
 ?>
 <html>
<head>
	<title>Invoice</title>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
	...
	<table class="data-table">
		<caption class="title">List Of Medicines <a href="print_ml.php" style="color: red;">(Print)</a><-------><a href="ex_ml.php" style="color: red;">(Download Excel File)</a></caption>
		<thead>
			<tr>
				<th>ID</th>
				<th>MEDICINE</th>
...
echo "<td>".$row['id']."</a>
<a href='delete.php?id1=" .$row['id'] ."'>Delete</a></td>";
