...
<script src="dj/js/refreshform.js"></script>
<script type="text/javascript">
function SetDate()
{
var date = new Date();
...
<center>
	<form id="form">
		<!-- ============================== Fieldset 1 ============================== -->
		<fieldset>
			<legend>Issue Medicines To Paitents</legend><br>
			<p><label>Case_No:</label>
				<input type="text" id="c" placeholder="Your Name"/></p>
				<br/>
				<p><label>Date:</label>
				
				<input type="text" id="name" placeholder="Your Name"/></p><br/>
				
				<p><label>Name:</label>
				
				<input type="text" id="email" placeholder="Your Email"/></p><br/>
				
				<p><label>Age:</label>
				
               <input type="text" id="contact1" placeholder="Your Mobile No."/></p><br/>
...
<p><label>Sex:</label>
				...
				<input type="radio" name="gender" value="other">Other</input></p>
<br/><br/>
<p><label>Religion:</label>
 ...
 <p><label>Diagnosis:</label>
				...
				<input type="text" id="diagnosis" /></p><br/>
        ...
        <?php } ?>
         ...
         <p><label>Batch_No:</label>
				...
				<input type="text" id="name1" placeholder="Your Name"/></p><br/>
