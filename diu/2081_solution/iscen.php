...
function dhaval(val)
{
 ...
 $.ajax({
     type: 'post',
     url: 'dj/dhaval111.php',
     data: {
       get_option:val
     },
     success: function (response) {
        //alert(response);
       document.getElementById("co").value=response; 
     }
   });
}
</script>
...
-->
<script src="dj/js/jquery.js"></script>
<script src="dj/js/refreshform2.js"></script>
...
<center>
	<form id="form">
		<!-- ============================== Fieldset 1 ============================== -->
		<fieldset>
			<legend>Other Transfers</legend><br>
			<p><label>center:</label>  <select name="cen_name" id="c_name"  onchange="dhaval(this.value);"><option>---select---</option>
		   	<?php
                include 'connect.php';
                      $driver = mysql_query("SELECT * FROM centers");
			...
			<p><label>Code:</label> <input type="text" name="bbb" id="co"></p><br>
					    <p><label>Date:</label> <input type="text" name="date" id="date"></p><br>
		   <p><label>Select Medicines:</label> <select name="drug_name" id="drug_name"  onchange="feestype(this.value);"><option>---select---</option>
		   	<?php
                include 'connect.php';
                      $driver = mysql_query("SELECT * FROM stock");
                      while($row = mysql_fetch_array($driver))
                      {
			...
			<p><label>Batch No:</label> <input type="text" name="b" id="cost"></p><br>
			<p> <label>Quantity:</label>
				
				<input type="text" id="name1" /></p><br/>
