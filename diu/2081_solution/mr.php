...
include("connect.php");
 ...
 $result1=mysql_query("REPLACE INTO monthly (medicine, type, batch_no,close,open,sold_date)
SELECT stock_current.name, stock_current.type, stock_current.batch,stock_current.current,stock_current.current + 1, stock_current.sold_date from stock_current group by stock_current.name   ");
 if($result1)
 {
 	echo mysql_error();
 }
...
//$result111=mysql_query("REPLACE INTO Final_stock (last_name, first_name)
 ...
 stock.exp AS exp
 FROM stock");*/
 $result=mysql_query("SELECT * FROM monthly");
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <caption class="title"><div class="no"><a href="ex_mr.php" style="color: red;">(Download Excel File)</a></div>
         <div align ="center"> <font color="red">Authorized By : ....................</font> </div>
    </caption>
     <thead>
			<tr>
				<th>ID</th>
