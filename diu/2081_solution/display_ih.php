...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <caption class="title"><div class="no"><a href="print_ih.php" style="color: red;">(Print All)</a><-------><a href="ex_ih.php" style="color: red;">(Download Excel File)</a><div class="no"><a href="#" onclick="window.print();"><font color="red">print</font></a></div></div> Individual History </caption>
    <thead>
    <?php
include("connect.php");
 $a=$_POST['case'];
 echo "<br>"; echo "<br>";
 echo "<b><center>"; echo "<h3>"; echo "<font color='blue'> Complete Details Of Case No "; echo $a; echo "</font></h3>"; echo "</center></b>";
