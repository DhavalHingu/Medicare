...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <caption class="title"><div class="no"><a href="print_pa.php" style="color: red;">(Print all)</a><-------><a href="ex_pa.php" style="color: red;">(Download Excel File)</a><br><a href="#" onclick="window.print();"><font color="red">print</font></caption>
    <thead>
<?php
  include('connect.php');
  $a=$_POST['from'];
$b=$_POST['to'];
echo "<br>"; echo "<br>";
 echo "<b><center>"; echo "<h3>"; echo "<font color='blue'> List Of Patient's Attendance As Date From:"; echo $a; echo " To:"; echo $b; echo "</font></h3>"; echo "</center></b>";


if(isset($_POST['submit']))
  {
    $result=mysql_query("SELECT case_no,age,sex,religion,diagnosis from details where date BETWEEN '$a' AND '$b' GROUP BY case_no");
