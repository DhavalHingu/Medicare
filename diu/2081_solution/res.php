...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <caption class="title"><div class="no"> <a href="#" onclick="window.print();" style="color: red;">(Print)</a></div>Details Of Medicines Whose Expire Within 2 weeks</caption>
    <thead>
    <?php


    $result=mysql_query("SELECT * FROM stock WHERE  DATEDIFF(exp, CURDATE()) BETWEEN 0 AND 14 " );
