...
echo "<br>"; echo "<br>";
 echo "<b><center>"; echo "<h3>"; echo "<font color='blue'> Purchase Register Of Challan No: "; echo $a; ; echo "</font></h3>"; echo "</center></b>";


if(isset($_POST['submit']))
  {
    $result=mysql_query("SELECT sid,sname,cn,cd,bn,bd from purchase_register where cn ='$a' group by cn");
  $result1=mysql_query("SELECT * from purchase_register where cn ='$a'");
