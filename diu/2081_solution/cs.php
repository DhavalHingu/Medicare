...
//$result111=mysql_query("REPLACE INTO Final_stock (last_name, first_name)
 ...
 stock.exp AS exp
 FROM stock");*/
 $result=mysql_query("SELECT * FROM recorder WHERE current <= 30");
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <caption class="title"><div class="no"><a href="cs.php" onclick="window.print();" style="color: red;">(Print)</a><-------><a href="ex_cs.php" style="color: red;">(Download Excel File)</a></div>Critical Stock</caption>
    <thead>
			<tr>
				<th>ID</th>
				<th>MEDICINES</th>
