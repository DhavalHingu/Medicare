...
include("connect.php");
 ...
 $result=mysql_query("select * from `diagnosis`");
 ?>
 <html>
<head>
	<title>Invoice</title>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
	...
	<table class="data-table">
		<caption class="title"><div class="no"> <a href="#" onclick="window.print();" style="color: red;">(Print)</a></div>List Of Diagnoses</caption>
		<thead>
			<tr>
				<th>ID</th>
				<th>CODE</th>
...
echo "<td>".$row['id']."</a>
<div class='no'><a href='delete.php?id1=" .$row['id'] ."'>Delete</a></div></td>";
			echo "<td>".$row['code']."</td>";
