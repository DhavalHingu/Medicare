...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <caption class="title"><div class="no"><a href="print_os.php" style="color: red;">(Print all)</a><-------><a href="ex_os.php" style="color: red;">(Download Excel File)</a><br><a href="#" onclick="window.print();"><font color="red">print</font></a> </div></caption>
    <thead>
<?php
  include('connect.php');
  $a=$_POST['from'];
$b=$_POST['to'];
echo "<br>"; echo "<br>";
 echo "<b><center>"; echo "<h3>"; echo "<font color='blue'> OPD Summary"; echo "</font></h3>"; echo "</center></b>";


if(isset($_POST['submit']))
  {
    $result=mysql_query("SELECT sum(quantity) AS qun,medicine,id,batch_no,date from details where date BETWEEN '$a' AND '$b' GROUP BY medicine");
